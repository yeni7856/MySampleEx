...
namespace MySampleEx
{
    ...
    public class AdManager : PersistentSingleton<AdManager>     //모든씬 끌고가는 싱글톤
    {
        ...
        public void ShowIinterstitialAd()           //서버한테 광고에 보여줄것을 받았을때만 보여줌
        {
        ...
        {
            RequestInterstitialAd();        //닫을때 광고 요청 다시 
        }
        #endregion
        ...
        public void RequestRewardAd()
        {
            ...
            RewardedAd.Load(_adUnitId, adRequest,
                (RewardedAd ad, LoadAdError error) =>
                {
                    ...
                    //RewardAd 이벤트 일어날때 호출되는 함수 등록
                    rewardedAd.OnAdFullScreenContentClosed += HandleOnRewardAdClose;
                });
        }
        public void ShowRewardAd()
        {
            ...
            if (rewardedAd != null && rewardedAd.CanShowAd())
            {
                ...
                {
                    // TODO: Reward the user. 동영상을 끝까지 보았을 경우 보상을 진행(1000)
